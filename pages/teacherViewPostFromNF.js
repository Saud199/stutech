...
class TeacherViewPostFromNF extends Component {
    ...
    return (
      ...
      <Container>
        ...
        <Content padder style={{ padding: 7 }}>
                ...
                <Text style={{fontWeight:'bold', marginTop:12, marginBottom : 10}}>Category : <Text style={{fontWeight:'normal'}}>{this.props.postDetails.category}</Text></Text>
      

                <Text style={{fontWeight:'bold', marginTop:12, marginBottom : 10}}>Event Type : <Text style={{fontWeight:'normal'}}>{this.props.postDetails.type}</Text></Text>
                

                <Text style={{fontWeight:'bold', marginTop:12, marginBottom : 10}}>Work Experience : <Text style={{fontWeight:'normal'}}>{this.props.postDetails.experience}</Text></Text>
...
export default connect(mapStateToProp, mapDispatchToProp)(TeacherViewPostFromNF);
