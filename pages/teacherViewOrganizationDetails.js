...
class TeacherViewOrganizationDetails extends Component {
    ...
    return (
      ...
      <Container>
        ...
        <Header style={{backgroundColor:'#14c2e0'}}>
          <Left>
            <Button transparent onPress={()=> this.props.navigation.navigate('TecaherViewOrganization')}>
        ...
        <Content padder style={{ padding: 7 }}>
                ...
                <Text style={{marginTop:12, marginBottom : 10}}>Organization Type : <Text style={{fontWeight:'normal'}}>{this.props.moreDetails.type}</Text></Text>
             

                <Text style={{marginTop:12, marginBottom : 10}}>Contact Number : <Text style={{fontWeight:'normal'}}>{this.props.moreDetails.number}</Text></Text>
               

                <Text style={{marginTop:12, marginBottom : 10}}>Email : <Text style={{fontWeight:'normal'}}>{this.props.moreDetails.email}</Text></Text>
               

                <Text style={{marginTop:12, marginBottom : 10}}>Address : <Text style={{fontWeight:'normal'}}>{this.props.moreDetails.address}</Text></Text>
...
export default connect(mapStateToProp, mapDispatchToProp)(TeacherViewOrganizationDetails);
