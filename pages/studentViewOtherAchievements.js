...
class StudentViewOtherAchievements extends Component {
    ...
    viewProfile(i){
     ...
     this.props.navigation.navigate("StudentViewOtherAchievementDetail") 
   }
          ...
          { AchievementsArr.map((val , ind) => {
            return(
                ...
                <Card>
                 ...
                 <Button block onPress={(e)=>{this.checkAchievementDetails(ind)}} style={{backgroundColor:"#14c2e0", width: 150, height: 40 , marginTop:9 ,alignSelf:'center'}}>
                  <Text>Details</Text>
                    </Button>
...
export default connect(mapStateToProp, mapDispatchToProp)(StudentViewOtherAchievements);